...
# Anodos Masternode Setup Guide (Ubuntu 18.04)
This guide will assist you in setting up an Anodos Masternode on a Linux Server running Ubuntu 18.04. (Use at your own risk)
...
![Example-OS](https://i.imgur.com/UcCQkIK.png)
***
...
`wget -q https://raw.githubusercontent.com/AnodosCore/Anodos-Masternode-Script-Ubuntu-18.04/master/ands_install.sh && bash ands_install.sh`
